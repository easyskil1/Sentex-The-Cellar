...
// Izzó korong / lágy fénykoszorú (a `shadowBlur` kiváltására, cache-elt bélyegzővel).
// A megvalósítás a SEMLEGES `game/render/glow` modulba költözött, hogy a bolt/UI is
// használhassa; itt újraexportáljuk, így a meglévő renderer-importok változatlanok.
export { glow, softGlow } from '../../../render/glow';
